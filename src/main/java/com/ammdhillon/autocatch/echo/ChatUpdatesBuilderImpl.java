...
import com.ammdhillon.autocatch.echo.database.DatabaseManagerImpl;
import com.ammdhillon.autocatch.echo.handlers.MessageHandler;
import com.ammdhillon.autocatch.echo.handlers.TLMessageHandler;
...
public class ChatUpdatesBuilderImpl implements ChatUpdatesBuilder {
    ...
    private OnNotificationAbstract onNotificationAbs;
    ...
    public ChatUpdatesBuilderImpl setOnNotificationAbs(OnNotificationAbstract onNotificationAbs) {
        this.onNotificationAbs = onNotificationAbs;
        return this;
    }
    ...
    public UpdatesHandlerBase build() throws NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        updatesHandler.setOnNotificationAbs(onNotificationAbs);
